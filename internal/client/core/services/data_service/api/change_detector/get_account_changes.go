...
func (d ChangeDetector) GetAccountChanges(user models.User, items []models.Account, externalItems []models.ExternalAccount) (created []models.Account, updated []models.Account, deleted []models.Account) {

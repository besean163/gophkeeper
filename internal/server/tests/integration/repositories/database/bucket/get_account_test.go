...
func TestGetAccount(t *testing.T) {
	...
	account, err = r.GetAccount("00000000-0000-0000-0000-000000000002")
	assert.Nil(t, err)
	assert.Equal(t, account_2, account)

	account, err = r.GetAccount("00000000-0000-0000-0000-000000000003")
	assert.Nil(t, err)

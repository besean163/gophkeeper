...
func TestUpdateNote(t *testing.T) {
	...
	var err error
	item := models.Note{ID: 1, UserID: user.ID, UUID: "00000000-0000-0000-0000-000000000001", Name: "name_1_new", Content: "text_1_new", CreatedAt: 1, UpdatedAt: 2}
	...
	assert.Nil(t, err)
	assert.Equal(t, &models.Note{ID: 1, UserID: user.ID, UUID: "00000000-0000-0000-0000-000000000001", Name: "name_1_new", Content: "text_1_new", CreatedAt: 1, UpdatedAt: 2}, updateItem)
}

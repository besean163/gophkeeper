...
func AccountCreateRoute(dep dependencies.Dependencies) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		input := entities.AccountPostInput{}
		...
		if err := dep.BucketService.CreateAccount(*user, &account); err != nil {

...
func (d ChangeDetector) GetCardsChanges(user models.User, items []*models.Card, externalItems []models.ExternalCard) (created []*models.Card, updated []*models.Card, deleted []string) {
